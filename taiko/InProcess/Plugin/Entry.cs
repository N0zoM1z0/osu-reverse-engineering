...
[assembly: AssemblyTitle("LocalTaikoAgent.Plugin")]
[assembly: AssemblyDescription("In-process local osu!taiko Player-input agent experiment")]
...
namespace LocalTaikoAgent.Plugin
{
    public static class Entry
    {
        ...
        public static void Start()
        {
            ...
            worker.Name = "LocalTaikoAgent.Plugin";
        ...
        private static void WorkerMain()
        {
            ...
            try
            {
                ...
                controls = new AgentControlState(IsTrue(
                    Environment.GetEnvironmentVariable("TAIKO_AGENT_ENABLED")));
                ...
                Log("ready; " + controls.GetOptions().Describe()
                    + ", architecture=normal Taiko Player input"
